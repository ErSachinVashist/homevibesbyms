                    ...
                    >
                        ...
                        <div className="relative group cursor-pointer">
                            ...
                            <div className="w-80 h-80 lg:w-96 lg:h-96 bg-gradient-to-br from-orange-100 to-amber-200 rounded-full flex items-center justify-center shadow-2xl group-hover:shadow-3xl transition-all duration-500 hover:scale-105">
                                <div className="w-64 h-64 lg:w-80 lg:h-80 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl transform rotate-12 flex items-center justify-center group-hover:rotate-6 transition-transform duration-500 relative overflow-hidden">
                                    <span className="text-white text-lg font-semibold transform -rotate-12 group-hover:-rotate-6 transition-transform duration-500 z-10">Autumn Vibes</span>
                                    {/* Decorative pattern */}
